...
if(isset($_GET['cha'])){
    ...
    header('location: /pharmacist/order/add.php');
}
$name = '';
$update = false;
...
if(isset($_POST['send'])){
  $name = $_POST['name'];
$insert = "INSERT INTO `order` VALUES(null,'$name')";
...
?>
<?php if($noc == '1') : ?>
<a href="/pharmacist/order/add cat.php?cha=2" name="cha" class="btn btn-dark">Dark mood</a>
<?php else : ?>
<a href="/pharmacist/order/add cat.php?cha=1" name="cha" class="btn btn-light">Light mood</a>
<?php endif ; ?>
    <div class="home">
        <?php if($update):?>
    <h1 class="display-1 text-center text-info">Update Order</h1>
    <?php else :?>
    <h1 class="display-1 text-center text-info">Add Order</h1>
    <?php endif; ?>
    </div>
		  ...
		  <div class="col-12 col-md-9 col-lg-7 col-xl-6">
			<div class="card" style="border-radius: 15px;">
			  <div class="card-body p-5">
				<h2 class="text-uppercase text-center mb-5">Create Order</h2>
				  <div class="form-outline mb-4">
            <form method="POST">
              <?php if ($update) : ?>
					<input type="text" id="form3Example1cg" name="name"  class="form-control form-control-lg" value="<?php echo $name ?>">
              <?php else :?>
					<input type="text" id="form3Example1cg" name="name"  class="form-control form-control-lg" placeholder="order">
          <?php endif ; ?>
